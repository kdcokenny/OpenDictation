...
final class DictationStateMachine: ObservableObject {
    ...
    // MARK: - Fast-Path Optimization
    
    /// Threshold for skipping processing animation (in seconds)
    private let fastPathThreshold: TimeInterval = 0.5
    ...
    func send(_ event: DictationEvent) {
        ...
        case (.recording, .hotkeyPressed),
            ...
            // Start transcription, track time for fast-path
